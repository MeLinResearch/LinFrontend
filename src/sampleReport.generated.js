...
<article class="lf-doc">
  ...
  <div class="lf-doc-body">
    ...
    <div class="lf-block">
      ...
      <dl class="lf-prov" data-anchor-id="a-prov"><div><dt>Source file</dt><dd>whatsapp-export-2026-02-18.txt</dd></div><div><dt>Received</dt><dd>18 Feb 2026, 08:57</dd></div><div><dt>Analysis run</dt><dd>run-9f2c41d8</dd></div><div><dt>Report format</dt><dd>public-report-v1</dd></div></dl>
    </div>

    <div class="lf-block">
      <h3>Patterns identified &middot; 6 cited excerpts</h3>
      <div class="lf-group"><div class="lf-group-name" data-anchor-id="a-group"><span class="lf-pin">2</span>Pressure or obligation language<span class="lf-group-count">4</span></div><p class="lf-group-desc">Language that may apply guilt, obligation, shame, or responsibility pressure.</p><ul class="lf-quotes"><li><div class="lf-quote" data-anchor-id="a-quote"><span class="lf-pin">3</span>&ldquo;I have never felt this connected to anyone&rdquo;</div><div class="lf-quote-meta"><span>Contact (unverified)</span><span>11 Feb 2026, 20:14</span><span>message <code>m01</code></span></div></li><li><div class="lf-quote">&ldquo;If you actually cared about me you would not be making this so difficult&rdquo;</div><div class="lf-quote-meta"><span>Contact (unverified)</span><span>16 Feb 2026, 03:02</span><span>message <code>m06</code></span></div></li><li><div class="lf-quote">&ldquo;I need you to send 4,000 now or I lose the whole position&rdquo;</div><div class="lf-quote-meta"><span>Contact (unverified)</span><span>18 Feb 2026, 04:41</span><span>message <code>m07</code></span></div></li><li><div class="lf-quote">&ldquo;There is no time to think about it&rdquo;</div><div class="lf-quote-meta" data-anchor-id="a-meta"><span class="lf-pin">4</span><span>Contact (unverified)</span><span>18 Feb 2026, 04:41</span><span>message <code>m07</code></span></div></li></ul></div><div class="lf-group"><div class="lf-group-name">Restriction or separation language<span class="lf-group-count">1</span></div><p class="lf-group-desc">Language suggesting isolation, separation, access limits, or control-like restriction.</p><ul class="lf-quotes"><li><div class="lf-quote">&ldquo;Please don&#x27;t tell your friends about us yet&rdquo;</div><div class="lf-quote-meta"><span>Contact (unverified)</span><span>14 Feb 2026, 01:12</span><span>message <code>m04</code></span></div></li></ul></div><div class="lf-group"><div class="lf-group-name">Monitoring or compliance pressure<span class="lf-group-count">1</span></div><p class="lf-group-desc">Language emphasizing surveillance, proof demands, tracking, or compliance checks.</p><ul class="lf-quotes"><li><div class="lf-quote">&ldquo;I run a private commodities desk in Geneva&rdquo;</div><div class="lf-quote-meta"><span>Contact (unverified)</span><span>12 Feb 2026, 23:47</span><span>message <code>m03</code></span></div></li></ul></div>
    </div>
