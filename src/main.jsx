    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t border-slate-200 bg-white mt-16">
        <div className="max-w-5xl mx-auto px-6 py-8 space-y-3">
          ...
          <p className="text-sm text-slate-500">LinForensics does not provide legal, medical, mental health, emergency, investigative, or professional advice.</p>
        </div>
      </footer>
    </div>
  );
